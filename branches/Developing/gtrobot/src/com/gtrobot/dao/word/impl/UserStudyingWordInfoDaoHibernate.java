...
public class UserStudyingWordInfoDaoHibernate extends BaseDaoHibernate
    ...
    public List getUserWordStudyingInfos() {
        return this.getHibernateTemplate().find("from UserWordStudyingInfo");
    ...
    public UserWordStudyingInfo getUserWordStudyingInfo(final Long userId) {
        final UserWordStudyingInfo userWordStudyingInfo = (UserWordStudyingInfo) this
                .getHibernateTemplate().get(UserWordStudyingInfo.class, userId);
        if (userWordStudyingInfo == null) {
            this.log.debug("uh oh, UserWordStudyingInfo with userId '" + userId
                    + "' not found...");
            // throw new
    ...
    public void saveUserWordStudyingInfo(
        ...
        this.getHibernateTemplate().saveOrUpdate(userWordStudyingInfo);
    }
    ...
    public void removeUserWordStudyingInfo(final Long userId) {
        this.getHibernateTemplate()
                .delete(this.getUserWordStudyingInfo(userId));
    }
}
