...
public class WordUnitEntryDaoHibernate extends BaseDaoHibernate implements
    ...
    public List getWordUnitEntrys() {
        return this.getHibernateTemplate().find("from WordUnitEntry");
    ...
    public WordUnitEntry getWordUnitEntry(final WordUnitEntryKey key) {
        final WordUnitEntry wordUnitEntry = (WordUnitEntry) this
                .getHibernateTemplate().get(WordUnitEntry.class, key);
        if (wordUnitEntry == null) {
            this.log.debug("uh oh, wordUnitEntry with key '" + key
                    + "' not found...");
            return null;
        }
    ...
    public void saveWordUnitEntry(final WordUnitEntry wordUnitEntry) {
        this.getHibernateTemplate().saveOrUpdate(wordUnitEntry);
    }
    ...
    public void removeWordUnitEntry(final WordUnitEntryKey key) {
        this.getHibernateTemplate().delete(this.getWordUnitEntry(key));
    }
}
