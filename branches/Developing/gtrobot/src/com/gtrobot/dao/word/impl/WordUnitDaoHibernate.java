...
public class WordUnitDaoHibernate extends BaseDaoHibernate implements
    ...
    public List getWordUnits() {
        return this.getHibernateTemplate().find(
                "from WordUnit order by wordUnitId");
    ...
    public List getWordUnitsNotInUserList(final Long userEntryId) {
        ...
        return this.getHibernateTemplate().find(hql, userEntryId);
    }
    ...
    public WordUnit getWordUnit(final Long wordUnitId) {
        final WordUnit wordUnit = (WordUnit) this.getHibernateTemplate().get(
                WordUnit.class, wordUnitId);
        if (wordUnit == null) {
            this.log.debug("uh oh, wordUnit with wordUnitId '" + wordUnitId
                    + "' not found...");
    ...
    public void saveWordUnit(final WordUnit wordUnit) {
        this.getHibernateTemplate().saveOrUpdate(wordUnit);
    }
    ...
    public void removeWordUnit(final Long wordUnitId) {
        this.getHibernateTemplate().delete(this.getWordUnit(wordUnitId));
    }
}
